...
router.post(
  "/addPackageCategory",
  upload.single("image"),
  adminController.addPackageCategory
);
...
router.post(
  ...
  adminController.getSinglePackageCategory
);
router.post("/getSinglePackage", adminController.getSinglePackage);
router.post(
  "/updatePackageCategory",
  upload.single("image"),
  adminController.updatePackageCategory
);
router.post(
  "/updatePackage",
  upload.single("image"),
...
router.post(
  ...
  adminController.bookingOrderStatusChange
);

router.get("/dashboardCount", adminController.dashboardCount);

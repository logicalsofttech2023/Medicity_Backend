...
//set up url
router.post("/userSignup",upload.single('userProfile'),userController.userSignup);
router.post('/getUser',userController.getUser);
router.post('/deleteUser',userController.deleteUser);
router.post('/updateUser',upload.single('userProfile'),userController.updateUser);
...
router.post("/getPackageDetails",userController.getPackageDetails);
 ...
 router.get("/tophealthCheckuppackageList",userController.tophealthCheckuppackageList);
  router.post("/filterPackagesByAgeAndGender",userController.filterPackagesByAgeAndGender);
...
router.post("/getRecentlyViewedPackages",userController.getRecentlyViewedPackages);
...
router.post('/addAppointment',upload.single('image'),userController.addAppointment);
...
router.post('/addPrescription',upload.array('files'),userController.addPrescription);
